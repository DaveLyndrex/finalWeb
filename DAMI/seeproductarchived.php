          ...
          <td>
              <style>   
                  .fa-recycle {
                    ...
                    <a href="connection.php?unarchivedproduct=<?php echo $row['productId'];?>&unarchivedphoto=<?php echo $row['productPhoto'];?>&unarchivedname=<?php echo $row['productName'];?>&unarchivedbrand=<?php echo $row['productBrand'];?>&unarchivedDescription=<?php echo $row['productDescription'];?>&unarchivedPrice=<?php echo $row['productPrice'];?>&un   archivedstocks=<?php echo $row['stocks'];?>"
                    class="btn btn-info" >Unarchived</a>
