...
<tr>                     
          ...
          <td>
           ...
           <a href="connection.php?approvedrequest=<?php echo $row['productId'];?>&approvedphoto=<?php echo $row['productPhoto'];?>&approvedname=<?php echo $row['productName'];?>&approvedbrand=<?php echo $row['productBrand'];?>&approvedDescription=<?php echo $row['productDescription'];?>&approvedPrice=<?php echo $row['productPrice'];?>&approvedstocks=<?php echo $row['stocks'];?>&approvedcomments=<?php echo $row['comments'];?>&username=<?php echo $row['username'];?>"
